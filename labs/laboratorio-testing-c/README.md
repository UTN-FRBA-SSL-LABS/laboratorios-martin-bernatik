...
> R:Este Test falla, esperaba 700 y obtuvo 350
...
> R:Esta en la linea 24 y dice que " BUG: falta multiplicar por cantidad"
...
> R:Falla, devuelve 1 cuando esperaba 0
...
> R:en carrito.c esta la linea 29 y 30 con "#####" debido a que estan cubiertas por los test de test_integracion.c y no por los de test_unitarios que utiliza make cobertura
...
> R:Los tests de integración verifican que las funciones trabajan bien en combinación, mientras que los unitarios solo curben lineas. Los test_unitarios fueron los primeros en detectar el bug de carrito_total
...
> R:es peligroso porque se puede pisar valores de otras variables,perder informacion y tendrian un comportamiento indefinido, a diferencia de pyton o java que poseen mecanismos de verificacion de limites 
...
> R:con este enfonque de escribir test, sabes que lineas son las que presentan el error
...
> R:porque la cantidad de los productos en el carrito en test_total_precio_unitario era 1, asi que no modifica en nada multiplicar por 1 
